package br.com.javaspringcurso.unittests.mockito.services;
...
import br.com.javaspringcurso.unittests.mapper.mocks.MockPerson;
...
public class PersonServicesTest {
    ...
    void testCreateWithNullPerson() {
        ...
        String expectedMessage = "It is not allowed to persist a null objetc!";
        String actualMesssage = exception.getMessage();

        assertTrue(actualMesssage.contains(expectedMessage));
    }
